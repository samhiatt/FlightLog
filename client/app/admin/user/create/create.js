/**
 * @ngdoc overview
 * @name flightLogApp.admin.user.create
 * @description
 * The `flightLogApp.admin.user.create` module which provides
 *
 * - {@link flightLogApp.admin.user.create.controller:UserCreateController UserCreateController}
 *
 * @requires ui.router
 * @requires ngMaterial
 * @requires ngMessages
