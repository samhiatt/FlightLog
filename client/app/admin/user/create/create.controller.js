/**
 * @ngdoc controller
 * @name flightLogApp.admin.user.create.controller:UserCreateController
 * @description
...
(function () {
	...
	angular
		.module('flightLogApp.admin.user.create')
		.controller('UserCreateController', UserCreateController);

	/**
	 * @ngdoc function
	 * @name flightLogApp.admin.user.create.provider:UserCreateController
	 * @description
	 * Provider of the {@link flightLogApp.admin.user.create.controller:UserCreateController UserCreateController}
	 *
	 ...
	 * @returns {Service} {@link flightLogApp.admin.user.create.controller:UserCreateController UserCreateController}
	 */
	...
	function UserCreateController($mdDialog, Auth, User, Toast) {
		 ...
		 * @ngdoc property
		 * @name userRoles
		 * @propertyOf flightLogApp.admin.user.create.controller:UserCreateController
		 * @description
		 ...
		 * @ngdoc function
		 * @name create
		 * @methodOf flightLogApp.admin.user.create.controller:UserCreateController
		 * @description
