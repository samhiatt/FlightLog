(function () {
	...
	/**
	 * Introduce the flightLogApp.user module
	 * and configure it.
	 *
	 * @requires ngResource
	 * @requires ui.router
	 * @requires {flightLogApp.admin.user.list}
	 * @requires {flightLogApp.admin.user.create}
	 */
	angular
		.module('flightLogApp.admin.user', [
			'ngResource',
			'ui.router',
			'flightLogApp.admin.user.list',
			'flightLogApp.admin.user.create'
		])
