/**
 * @ngdoc overview
 * @name flightLogApp.admin.user.list.detail
 * @description
 * The `flightLogApp.admin.user.list.detail` module which provides:
 *
 * - {@link flightLogApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
 *
 * @requires ui.router
 * @requires angularMoment
 * @requires flightLogApp.auth.user
 */
(function () {
	'use strict';
