/**
 * @ngdoc controller
 * @name flightLogApp.admin.user.list.edit.controller:UserEditController
 * @description
...
(function () {
	...
	/**
	 * @ngdoc function
	 * @name flightLogApp.admin.user.list.edit.provider:UserEditController
	 * @description
	 * Provider of the {@link flightLogApp.admin.user.list.edit.controller:UserEditController UserEditController}
