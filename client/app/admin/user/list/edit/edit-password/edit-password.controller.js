/**
 * @ngdoc controller
 * @name flightLogApp.admin.user.list.edit.controller:EditPasswordController
 * @description
...
(function () {
	...
	angular
		.module('flightLogApp.admin.user.list.edit')
		.controller('EditPasswordController', EditPasswordController);


	/**
	 * @ngdoc function
	 * @name flightLogApp.admin.user.list.edit.provider:EditPasswordController
	 * @description
	 * Provider of the {@link flightLogApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
	 *
	 ...
	 * @returns {Service} {@link flightLogApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
	 */
	...
	function EditPasswordController($mdDialog, UserService, user, Toast) {
		 ...
		 * @ngdoc function
		 * @name changePassword
		 * @methodOf flightLogApp.admin.user.list.edit.controller:EditPasswordController
		 * @description
