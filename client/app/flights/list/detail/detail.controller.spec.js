...
describe('Controller: FlightDetailController', function () {

	// load the controller's module
	beforeEach(module('flightLogApp.list.detail'));
	...
	beforeEach(inject(function ($state) {
		...
		flight = {_id: '1337id', name: 'admin', active: true};
	}));

	// Initialize the controller and a mock scope
	beforeEach(inject(function ($controller) {
		controller = $controller('FlightDetailController', {
			user: user
		});
	}));
	...
	it('should have a user property which is the current flight', function () {
